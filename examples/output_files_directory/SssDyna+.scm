...
(define (ssigma-dyna-define-anywhere L t) ($nfx$ cpt <- cpt + 1)
 (<+ ls (length L)) (<+ dyn (bracket-apply dyna ls t)) (def c) (def R)
 (one?
  (if (not (zero? dyn)) dyn
   ($>
    (<- (bracket-apply dyna ls t)
     (tf->12
      (if (null? L) #f
       ($> (<- c (first L)) (<- R (rest L))
...
(define (ssigma-dyna-def L t) (display L) (newline) (display t) (newline)
 (newline) ($nfx$ cpt <- cpt + 1) (def (ls dyn)) (<- ls (length L))
 (<- dyn (bracket-apply dyna ls t)) (def c) (def R)
 (one?
  (if (not (zero? dyn)) dyn
   ($>
    (<- (bracket-apply dyna ls t)
...
(def (subset-sum-dyna L t) (declare ls dyn) (<- ls (length L))
 (<- dyn (bracket-apply dyna ls t)) (if (<> dyn 0) (return (one? dyn)))
 (when (null? L) (<- (bracket-apply dyna ls t) 2) (return #f)) (<+ c (first L))
 (when (= c t) (<- (bracket-apply dyna ls t) 1) (return #t)) (<+ R (rest L))
 (declare s)
 (if (> c t) (<- s (subset-sum-dyna R t))
  ($nfx$ s <- (subset-sum-dyna R (- t c)) or (subset-sum-dyna R t)))
 (<- (bracket-apply dyna ls t) (tf->12 s)) s)
...
(def (subset-sum-dynamic L t) (declare ls dyn c R s) (<- ls (length L))
 ...
 (if (> c t) (<- s (subset-sum-dynamic R t))
  ($nfx$ s <- (subset-sum-dynamic R (- t c)) or (subset-sum-dynamic R t)))
 (<- (bracket-apply dyna ls t) (tf->12 s)) s)

(def (subset-sum-dynamic-new-syntax L t) (declare ls dyn c R s)
 (<- ls (length L)) (<- dyn (bracket-apply dyna ls t))
 (if (<> dyn 0) (return (one? dyn)))
 (if (null? L) then (<- (bracket-apply dyna ls t) 2) (return #f))
 (<- c (first L))
 (if (= c t) then (<- (bracket-apply dyna ls t) 1) (return #t)) (<- R (rest L))
 (if (> c t) then (<- s (subset-sum-dynamic-new-syntax R t)) else
  ($nfx$ s <- (subset-sum-dynamic-new-syntax R (- t c)) or
   (subset-sum-dynamic-new-syntax R t)))
 (<- (bracket-apply dyna ls t) (tf->12 s)) s)

(define (subset-sum-condx L t) (declare ls dyn) (<- ls (length L))
 (<- dyn (bracket-apply dyna ls t))
 (condx ((<> dyn 0) (one? dyn)) ((null? L) (<- (bracket-apply dyna ls t) 2) #f)
  (exec (<+ c (first L))) ((= c t) (<- (bracket-apply dyna ls t) 1) #t)
  (exec (<+ R (rest L)))
  ((> c t) (<+ s (subset-sum-condx R t))
   (<- (bracket-apply dyna ls t) (tf->12 s)) s)
  (else ($nfx$ s <+ (subset-sum-condx R (- t c)) or (subset-sum-condx R t))
   (<- (bracket-apply dyna ls t) (tf->12 s)) s)))

(define (subset-sum L t) (<+ ls (length L)) (<+ dyn (bracket-apply dyna ls t))
 ($nfx$ cpt <- cpt + 1)
 (condx ((<> dyn 0) (one? dyn)) ((null? L) (<- (bracket-apply dyna ls t) 2) #f)
  (exec (<+ c (first L))) ((= c t) (<- (bracket-apply dyna ls t) 1) #t)
  (exec (<+ R (rest L)))
  ((> c t) (<+ s (subset-sum R t)) (<- (bracket-apply dyna ls t) (tf->12 s)) s)
  (else ($nfx$ s <+ (subset-sum R (- t c)) or (subset-sum R t))
   (<- (bracket-apply dyna ls t) (tf->12 s)) s)))

(define (subset-sum-dec L t) (declare ls dyn c R s) (<- ls (length L))
 (<- dyn (bracket-apply dyna ls t)) ($nfx$ cpt <- cpt + 1)
 (condx ((<> dyn 0) (one? dyn)) ((null? L) (<- (bracket-apply dyna ls t) 2) #f)
  (exec (<- c (first L))) ((= c t) (<- (bracket-apply dyna ls t) 1) #t)
  (exec (<- R (rest L)))
  ((> c t) (<- s (subset-sum-dec R t))
   (<- (bracket-apply dyna ls t) (tf->12 s)) s)
  (else ($nfx$ s <- (subset-sum-dec R (- t c)) or (subset-sum-dec R t))
   (<- (bracket-apply dyna ls t) (tf->12 s)) s)))

(define (subset-sum-value L t) (declare ls dyn c R s) (<- ls (length L))
 (<- dyn (bracket-apply dyna ls t)) ($nfx$ cpt <- cpt + 1)
 (condx ((not (equal? dyn 0)) dyn)
  ((null? L) (<- (bracket-apply dyna ls t) #f) #f) (exec (<- c (first L)))
  ((= c t) (<- s (bracket-apply dyna ls t) (list c)) s) (exec (<- R (rest L)))
  ((> c t) (<- s (subset-sum-value R t)) (<- (bracket-apply dyna ls t) s) s)
  (exec (<- s (subset-sum-value R (- t c))))
  (s (<- s (bracket-apply dyna ls t) (cons c s)) s)
  (exec (<- s (subset-sum-value R t)))
  (else (<- (bracket-apply dyna ls t) s) s)))
